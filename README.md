...
2. Press **Start** to play the first question; tap **Replay** to hear it again.
3. Tap an answer chip to submit your guess. The correct answer is highlighted; if you picked wrong, your choice is also marked.
4. Press **Next question** to advance.
5. **Score** shows correct out of attempted; **Streak** tracks consecutive correct answers. Press **Reset** to clear the session.
