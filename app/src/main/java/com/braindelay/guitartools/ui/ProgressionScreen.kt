    ...
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            if (vm.progression.isEmpty()) {
                Text(
                    "Select a note and chord type on the right, then tap Add.",
        ...
        Row(
            ...
            // Circle of fifths + add button + voicings
            Column(
                ...
                Row(
                    ...
                    Button(
                        onClick = { selectedNote?.let { vm.addChord(it, selectedChordType) } },
                ...
                Row(
                    ...
                    // Voicings for currently selected chord
